package com.example.wethercitycountryandstate;
...
public class City extends AppCompatActivity {
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.POST, CountrycodeUrl, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Toast.makeText(City.this, "kk"+e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                }
    ...
    public void nextPage(View view) {
        Intent intent=new Intent(City.this,MainActivity2.class);
